...
export default function ForumFilter(props: any) {
                            ...
                            <Grid container item xs={4} justifyContent={'flex-end'} alignItems={'center'} >
                                <Link  >
                                    <Typography
                                        ...
                                        onClick={() => {
                                            props.setSelCompanyFilter([]); props.setSelForumFilter([]); push(`${pathname}${searchParams.get('page') ? `?page=${searchParams.get('page')}` : `?page=1`}${searchParams.get('search') ? `&search=${searchParams.get('search')}` : ''}`)
                                        }}
                                    >
                                        Clear All
                                    </Typography>
