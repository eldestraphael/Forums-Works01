...
import ForumDasboard from './dashboard';
...
function Page(props: any) {
    ...
    const [ViewForums, setViewForums] = useState<any>([]);
    const [addForums, setAddForums] = useState<any>([]);
    ...
    if (allForumsAction?.length > 0) {
        return (
            <ForumDasboard allForumsAction={allForumsAction} addForums={addForums}/>
        )
    } else {
        return (
