...
function Page(props: any) {
    ...
    if (allForumsAction?.length > 0 && addForumsAction?.length > 0 && viewForumsAction?.length > 0) {
        return (
            <AllForums page_props={props} allForumsAction={allForumsAction} addForumsAction={addForumsAction} viewForumsAction={viewForumsAction} />
        )
    } else {
        return (
